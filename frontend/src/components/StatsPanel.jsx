...
export default function StatsPanel({ stats }) {
  return (
    <div className="space-y-8">
      <div className="bg-gradient-to-br from-card to-darker p-8 rounded-2xl border border-gray-800 shadow-lg relative overflow-hidden">
      ...
      {stats.weeklyData && stats.weeklyData.length > 0 && (
        <div className="bg-gradient-to-br from-card to-darker py-6 px-4 rounded-2xl border border-gray-800 shadow-lg relative overflow-hidden">
